...
public class Adm04AgregarPeriodoLaboral {
    ...
    public Adm04AgregarPeriodoLaboral(PeriodoRepository periodoRepository,
    ...
    public void el_actor_agrega_un_periodo_laboral(String codigoCalendarioLiteral, String codigo, String nombre,
            String recurrencia) {
        ...
        PeriodoLaboralDto resultado = calendarioService.agregarPeriodoLaboral(codigoCalendario, request);
        contextoCalendario
                .setPeriodoActual(periodoRepository.findByCalendario_CodigoAndCodigo(codigoCalendario, resultado.getCodigo())
                        .orElseThrow());
    }
    ...
    public void el_actor_intenta_agregar_un_periodo_laboral_sin_permisos(String codigoCalendarioLiteral) {
    ...
    private void intentarAgregar(String codigoCalendario, String fechaInicio, String fechaFin) {
        ...
        PeriodoInputDto request = new PeriodoInputDto().codigo("LAB-" + CalendarioFixtures.nuevoSufijo())
