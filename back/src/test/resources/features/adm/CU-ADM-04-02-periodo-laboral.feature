...
Característica: Definir un período LABORAL
  ...
  Para delimitar los rangos de fechas que se consideran días hábiles

  Esquema del escenario: Agregar un período LABORAL con cada tipo de recurrencia
    ...
    Cuando el actor agrega un período LABORAL con recurrencia "<recurrencia>" y los datos correspondientes
  ...
  Escenario: Rechazar un período LABORAL con código ya usado en el mismo calendario
  ...
  Escenario: Rechazar un período LABORAL cuya fecha de inicio es posterior a la fecha de fin
  ...
  Escenario: Rechazar un período LABORAL que no está enmarcado en el rango del calendario
  ...
  Escenario: Permitir que dos períodos LABORAL se intersecten sin generar conflicto
  ...
  Escenario: Rechazar la creación de un período LABORAL a un actor sin el rol adecuado
